    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-portlet">
            ...
            <div class="m-portlet__body">
                <a href="{{route('permission.create')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon mb-4">
                    <span>
                            ...
                            @foreach($data as $key => $item)
                                <tr>
                                    ...
                                    <td style="width: 15%;">
                                        ...
                                        <a href="{{route('permission.edit',[$item->id])}}" class="btn btn-success"><i class="fas fa-edit"></i></a>
